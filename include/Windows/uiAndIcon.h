...
class uiAndIcon{
    ...
    static std::string iconBase64;

public:
    static std::string GetUserInterface() { return userInterface; }

    static std::string GetBase64Icon() { return iconBase64; }

    static GdkPixbuf* GetIconPixBuf();
};